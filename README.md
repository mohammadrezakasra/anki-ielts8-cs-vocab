...
The underlying dataset is structured as a comprehensive matrix spreadsheet. The layout below illustrates the exact order of the columns mapped in the master database, showcasing how raw target corpuses flow sequentially into the final clean compilation. Click on any corpus header to visit its official EAP analytical reference:

| Column Order | Column Header | Data Scope & Target Utility |
| :---: | :--- | :--- |
| **1** | [`NGSL`](https://www.eapfoundation.com/vocab/general/ngsl/) | 2,801 High-Frequency Base Headwords covering the absolute foundation of general English text. |
| **2** | [`CSAVL`](https://www.eapfoundation.com/vocab/academic/other/csavl/#csavlmain) | 904 Core Academic Words—the absolute gold standard for computer science discourse. |
| **3** | [`CSAVL-S`](https://www.eapfoundation.com/vocab/academic/other/csavl/#csavlmain) | 702 Spoken Specialist Words tailored for computer science speech and academic lectures. |
| **4** | [`AWL(sublist 1)`](https://www.eapfoundation.com/vocab/academic/awllists/) | Sublist 1 of Averil Coxhead's Academic Word List (Most frequent academic families). |
| **5** | [`AWL(sublist 2)`](https://www.eapfoundation.com/vocab/academic/awllists/) | Sublist 2 of the Academic Word List. |
| **6** | [`AWL(sublist 3)`](https://www.eapfoundation.com/vocab/academic/awllists/) | Sublist 3 of the Academic Word List. |
| **7** | [`AWL(sublist 4)`](https://www.eapfoundation.com/vocab/academic/awllists/) | Sublist 4 of the Academic Word List. |
| **8** | [`AWL(sublist 5)`](https://www.eapfoundation.com/vocab/academic/awllists/) | Sublist 5 of the Academic Word List. |
| **9** | [`AWL(sublist 6)`](https://www.eapfoundation.com/vocab/academic/awllists/) | Sublist 6 of the Academic Word List. |
| **10** | [`AWL(sublist 7 & 8)`](https://www.eapfoundation.com/vocab/academic/awllists/) | Combined high-tier academic vocabulary from Sublists 7 and 8. |
| **11** | [`AWL(sublist9 & 10)`](https://www.eapfoundation.com/vocab/academic/awllists/) | Combined advanced academic vocabulary from Sublists 9 and 10. |
| **12** | [`COCA-5000`](https://www.eapfoundation.com/vocab/general/bnccoca/) | Top 5,000 highest frequency words from contemporary American English. |
...
*   **Optimal Text Coverage (95%+):** By integrating and cross-referencing the baseline NGSL with the complete Academic Word List (AWL) and the specialized CSAVL, this matrix grants automated recognition of **over 95% of words** encountered in standard academic literature and tech publications.
...
پایگاه داده اصلی این پروژه در قالب یک فایل اکسل ساختاریافته طراحی شده است. جدول زیر ترتیب دقیق ستون‌های موجود در این فایل و نحوه جریان داده‌های خام تا رسیدن به نسخه نهایی را نشان می‌دهد. با کلیک روی عنوان هر پیکره، می‌توانید مستقیماً وارد تحلیل رسمی آکادمیک آن در سایت EAP شوید:

| ترتیب ستون | نام سرستون (Header) | محدوده داده و هدف آکادمیک |
| --- | --- | --- |
| **۱** | [`NGSL`](https://www.eapfoundation.com/vocab/general/ngsl/) | تعداد ۲,۸۰۱ کلمه کلیدی پرکاربرد پایه؛ پوشش‌دهنده ساختار اصلی متون عمومی. |
| **۲** | [`CSAVL`](https://www.eapfoundation.com/vocab/academic/other/csavl/#csavlmain) | تعداد ۹۰۴ واژه آکادمیک هسته؛ استاندارد طلایی متون تخصصی علوم کامپیوتر. |
| **۳** | [`CSAVL-S`](https://www.eapfoundation.com/vocab/academic/other/csavl/#csavlmain) | تعداد ۷۰۲ واژه تخصصی گفتاری؛ بهینه‌شده برای سخنرانی‌ها و لکچرهای آکادمیک کامپیوتر. |
| **۴** | [`AWL(sublist 1)`](https://www.eapfoundation.com/vocab/academic/awllists/) | ساب‌لیست ۱ از واژگان آکادمیک Averil Coxhead (پرکاربردترین لغات دانشگاهی). |
| **۵** | [`AWL(sublist 2)`](https://www.eapfoundation.com/vocab/academic/awllists/) | ساب‌لیست ۲ از مجموعه واژگان آکادمیک AWL. |
| **۶** | [`AWL(sublist 3)`](https://www.eapfoundation.com/vocab/academic/awllists/) | ساب‌لیست ۳ از مجموعه واژگان آکادمیک AWL. |
| **۷** | [`AWL(sublist 4)`](https://www.eapfoundation.com/vocab/academic/awllists/) | ساب‌لیست ۴ از مجموعه واژگان آکادمیک AWL. |
| **۸** | [`AWL(sublist 5)`](https://www.eapfoundation.com/vocab/academic/awllists/) | ساب‌لیست ۵ از مجموعه واژگان آکادمیک AWL. |
| **۹** | [`AWL(sublist 6)`](https://www.eapfoundation.com/vocab/academic/awllists/) | ساب‌لیست ۶ از مجموعه واژگان آکادمیک AWL. |
| **۱۰** | [`AWL(sublist 7 & 8)`](https://www.eapfoundation.com/vocab/academic/awllists/) | ترکیب واژگان سطح بالای آکادمیک ساب‌لیست‌های ۷ و ۸. |
| **۱۱** | [`AWL(sublist9 & 10)`](https://www.eapfoundation.com/vocab/academic/awllists/) | ترکیب واژگان پیشرفته آکادمیک ساب‌لیست‌های ۹ و ۱۰. |
| **۱۲** | [`COCA-5000`](https://www.eapfoundation.com/vocab/general/bnccoca/) | ۵,۰۰۰ واژه اول و پرتکرار کورپوس انگلیسی معاصر آمریکا. |
...
* **پوشش متنی بی‌نظیر (بالای ۹۵٪):** تلفیق مهندسی‌شده لغات پایه NGSL با کل واژگان آکادمیک (AWL) و افزودن فیلتر تخصصی کامپیوتر (CSAVL)، به شما شناختی هوش‌ربا و خودکار نسبت به **بیش از ۹۵٪ واژگان** به‌کاررفته در متون دانشگاهی و مقالات لبه علم می‌دهد.
